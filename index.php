...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Portafolio Web Cristian</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand page-scroll" href="#page-top">Cristian Hurtado</a>
                </div>
        ...
        <!-- acerca de mi -->
        <?php include 'includes/acercademi.php' ?>
        
        <!-- logos cliente -->
        <?php include 'includes/logoscliente.php' ?>
