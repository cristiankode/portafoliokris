                       ...
                       {{--  <form id="contact-form" method="post" action="{{ route('messages') }}" role="form"> --}}
                        ...
                        {{ csrf_field() }} 
                            ...
                            <div id="submit" class="wow fadeInDown" data-wow-duration="500ms" data-wow-delay="1.4s">
                                <input type="submit" id="contact-submit" class="btn btn-default btn-send" value="Envíar Mensaje">
                            </div>                      
                        </form>
                    </div>
                </div>
        ...
        <div class="row address-details">
            ...
            <div class="col-md-4">
                <div class="address wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".5s">
                    <i class="ion-ios-location-outline"></i>
                    <!-- <h5>125 , Kings Street,Melbourne <br>United Kingdom,600562</h5> -->
                    <h5>Prol. Paseo de la Reforma 625,<br>Ciudad de Mexico, C.P.01330</h5>
                </div>
            </div>
            <div class="col-md-4">
