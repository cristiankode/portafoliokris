...
<head>
    ...
    <title>Cristian Professional Website</title>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="progress-wrapper">
                    ...
                    <div class="progress-item">
                        <span class="progress-title">Java Script(Jquery, Vue js)</span>
...
<section class="section-wrapper portfolio-section">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <a class="portfolio-item" href="https://ofijob.com/">
                    <div class="portfolio-thumb">
                        <img src="{{ asset('images/curriculum/ofijob.png') }}" alt="">
                    </div>

                    <div class="portfolio-info">
                        <h3>Bolsa de Trabajo</h3>
                        <small>ofijob.com</small>
                    </div>
                    <!-- portfolio-info -->
                </a>
                <!-- .portfolio-item -->
            ...
            <div class="col-md-6">
                <a class="portfolio-item" href="http://evolutionhc.com.mx/">
                    <div class="portfolio-thumb">
                        <img src="{{ asset('images/curriculum/evolution3.png')}}" alt="">
                    </div>
                    <div class="portfolio-info">
                        <h3>Especialistas en Factor Humano</h3>
                        <small>evolutionhc.com.mx</small>
                    </div>
                    <!-- portfolio-info -->
                </a>
                <!-- .portfolio-item -->
            ...
            <div class="col-md-6">
                <a class="portfolio-item" href="http://ammje.mx/representacion-ciudad-de-mexico">
                    <div class="portfolio-thumb">
                        <img src="{{ asset('images/curriculum/ammje.png')}}" alt="">
                    </div>

                    <div class="portfolio-info">
                        <h3>Asociación Mexicana de Mujeres Jefas de Empresa</h3>
                        <small>ammje.mx</small>
                    </div>
                    <!-- portfolio-info -->
                </a>
                <!-- .portfolio-item -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="copytext">&copy; All rights reserved | Design By: <a
                            href="https://developerlaravel.com">Cristian Hurtado</a></div>
                </div>
            </div>
            <!--.row-->
        </div>
